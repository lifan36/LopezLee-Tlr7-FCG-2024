...
LG93E4_integrated <- readRDS("LG93E4_integrated_PCA_0.1.rds")
#Remove cluster 9 - Choroid plexus epithelial cells, cluster 16-Reln+ CR cells
LG93E4_integrated <- subset(LG93E4_integrated, idents=c("9","16"), invert=T)
Idents(LG93E4_integrated) <- "seurat_clusters"
LG93E4_integrated <- RenameIdents(LG93E4_integrated,
                                 `0` = "oligodendrocytes", `1`="excitatory neurons", `2`="astrocytes", `3`="microglia",
                                 `4`="excitatory neurons", `5`="excitatory neurons", `6`="OPCs", `7`="excitatory neurons",
                                 `8`="excitatory neurons", `10`="vascular cells", `11`="excitatory neurons",
                                 `12`="inhibitory neurons", `13`="inhibitory neurons", `14`="inhibitory neurons",`15`="inhibitory neurons",
                                 `17`="vascular cells", `18`="vascular cells"
)

pdf("LG93E4_integrated_umap_annotation.pdf", width=6, height=3.8)
DimPlot(LG93E4_integrated, reduction = 'umap', label = T)
dev.off()

LG93E4_integrated$celltype.orig.ident <- paste(Idents(LG93E4_integrated), LG93E4_integrated$orig.ident, sep = "_")
LG93E4_integrated$celltype <- Idents(LG93E4_integrated)

saveRDS(LG93E4_integrated, file = "LG93E4_integrated_Annotation.rds")

data <- LG93E4_integrated
...
ggsave("genotype_celltype_distribution.pdf",plot=last_plot(),path="/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier",
...
ggsave("sample_celltype_distribution.pdf",plot=last_plot(),path="/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier",
       width=6,height=4,units="in")

Idents(LG93E4_integrated) <- "celltype"
DefaultAssay(LG93E4_integrated) <- 'RNA'
pdf("LG93E4_integrated_umap_annotation_noLabel.pdf", width=6, height=4)
DimPlot(LG93E4_integrated, reduction = 'umap', label = F)
dev.off()

Cluster_EN <- subset(LG93E4_integrated, idents = "excitatory neurons")
Cluster_IN <- subset(LG93E4_integrated, idents = "inhibitory neurons")
Cluster_MG <- subset(LG93E4_integrated, idents = "microglia")
Cluster_AST <- subset(LG93E4_integrated, idents = "astrocytes")
Cluster_OL <- subset(LG93E4_integrated, idents = "oligodendrocytes")
Cluster_OPC <- subset(LG93E4_integrated, idents = "OPCs")
Cluster_VC <- subset(LG93E4_integrated, idents = "vascular cells")


saveRDS(Cluster_EN, file = "LG93E4_EN_subset.rds")
saveRDS(Cluster_IN, file = "LG93E4_IN_subset.rds")
saveRDS(Cluster_MG, file = "LG93E4_MG_subset.rds")
saveRDS(Cluster_AST, file = "LG93E4_AST_subset.rds")
saveRDS(Cluster_OL, file = "LG93E4_OL_subset.rds")
saveRDS(Cluster_OPC, file = "LG93E4_OPC_subset.rds")
saveRDS(Cluster_VC, file = "LG93E4_VC_subset.rds")


#######################################################################
setwd("/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier/subclustering")
MG <- Cluster_MG
...
saveRDS(MG, file = 'LG93E4_MG_reclusted_res0.15.rds')
pdf("LG93E4_MG_umap_res0.15.pdf", width=3.3, height=2.7)
DimPlot(MG, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_MG_umap_Condition_res0.15.pdf", width=10, height=6)
DimPlot(MG, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_MG_umap_Sample_res0.15.pdf", width=18, height=12)
DimPlot(MG, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(MG) <- 'RNA'
LG93E4_MG_markers <- FindAllMarkers(MG, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_MG_markers, "LG93E4_MG_markers_res0.15.csv")
...
MG@active.ident <- plyr::mapvalues(x = MG@active.ident, from = current.cluster.ids, to = new.cluster.ids)
MG@active.ident <- factor(MG@active.ident, levels=1:n)
saveRDS(MG, file = 'LG93E4_MG_reclusted_res0.2.rds')
pdf("LG93E4_MG_umap_res0.2.pdf", width=3.3, height=2.7)
DimPlot(MG, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_MG_umap_Condition_res0.2.pdf", width=10, height=6)
DimPlot(MG, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_MG_umap_Sample_res0.2.pdf", width=18, height=12)
DimPlot(MG, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(MG) <- 'RNA'
LG93E4_MG_markers <- FindAllMarkers(MG, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_MG_markers, "LG93E4_MG_markers_res0.2.csv")
...
MG@active.ident <- plyr::mapvalues(x = MG@active.ident, from = current.cluster.ids, to = new.cluster.ids)
MG@active.ident <- factor(MG@active.ident, levels=1:n)
saveRDS(MG, file = 'LG93E4_MG_reclusted_res0.3.rds')
pdf("LG93E4_MG_umap_res0.3.pdf", width=3.3, height=2.7)
DimPlot(MG, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_MG_umap_Condition_res0.3.pdf", width=10, height=6)
DimPlot(MG, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_MG_umap_Sample_res0.3.pdf", width=18, height=12)
DimPlot(MG, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(MG) <- 'RNA'
LG93E4_MG_markers <- FindAllMarkers(MG, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_MG_markers, "LG93E4_MG_markers_res0.3.csv")
...
saveRDS(AST, file = 'LG93E4_AST_reclusted_res0.15.rds')
pdf("LG93E4_AST_umap.pdf", width=3.3, height=2.7)
DimPlot(AST, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_AST_umap_Condition.pdf", width=10, height=6)
DimPlot(AST, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_AST_umap_Sample.pdf", width=18, height=12)
DimPlot(AST, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(AST) <- 'RNA'
LG93E4_AST_markers <- FindAllMarkers(AST, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_AST_markers, "LG93E4_AST_markers.csv")
...
AST@active.ident <- plyr::mapvalues(x = AST@active.ident, from = current.cluster.ids, to = new.cluster.ids)
AST@active.ident <- factor(AST@active.ident, levels=1:n)
saveRDS(AST, file = 'LG93E4_AST_reclusted_res0.2.rds')
pdf("LG93E4_AST_umap_res0.2.pdf", width=3.3, height=2.7)
DimPlot(AST, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_AST_umap_Condition_res0.2.pdf", width=10, height=6)
DimPlot(AST, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_AST_umap_Sample_res0.2.pdf", width=18, height=12)
DimPlot(AST, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(AST) <- 'RNA'
LG93E4_AST_markers <- FindAllMarkers(AST, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_AST_markers, "LG93E4_AST_markers_res0.2.csv")
...
AST@active.ident <- plyr::mapvalues(x = AST@active.ident, from = current.cluster.ids, to = new.cluster.ids)
AST@active.ident <- factor(AST@active.ident, levels=1:n)
saveRDS(AST, file = 'LG93E4_AST_reclusted_res0.3.rds')
pdf("LG93E4_AST_umap_res0.3.pdf", width=3.3, height=2.7)
DimPlot(AST, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_AST_umap_Condition_res0.3.pdf", width=10, height=6)
DimPlot(AST, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_AST_umap_Sample_res0.3.pdf", width=18, height=12)
DimPlot(AST, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(AST) <- 'RNA'
LG93E4_AST_markers <- FindAllMarkers(AST, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_AST_markers, "LG93E4_AST_markers_res0.3.csv")
...
saveRDS(OL, file = 'LG93E4_OL_reclusted_res0.15.rds')
pdf("LG93E4_OL_umap.pdf", width=3.3, height=2.7)
DimPlot(OL, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OL_umap_Condition.pdf", width=10, height=6)
DimPlot(OL, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_OL_umap_Sample.pdf", width=18, height=12)
DimPlot(OL, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OL) <- 'RNA'
LG93E4_OL_markers <- FindAllMarkers(OL, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_OL_markers, "LG93E4_OL_markers.csv")
...
OL@active.ident <- plyr::mapvalues(x = OL@active.ident, from = current.cluster.ids, to = new.cluster.ids)
OL@active.ident <- factor(OL@active.ident, levels=1:n)
saveRDS(OL, file = 'LG93E4_OL_reclusted_res0.2.rds')
pdf("LG93E4_OL_umap_res0.2.pdf", width=3.3, height=2.7)
DimPlot(OL, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OL_umap_Condition_res0.2.pdf", width=10, height=6)
DimPlot(OL, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_OL_umap_Sample_res0.2.pdf", width=18, height=12)
DimPlot(OL, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OL) <- 'RNA'
LG93E4_OL_markers <- FindAllMarkers(OL, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_OL_markers, "LG93E4_OL_markers_res0.2.csv")
...
OL@active.ident <- plyr::mapvalues(x = OL@active.ident, from = current.cluster.ids, to = new.cluster.ids)
OL@active.ident <- factor(OL@active.ident, levels=1:n)
saveRDS(OL, file = 'LG93E4_OL_reclusted_res0.3.rds')
pdf("LG93E4_OL_umap_res0.3.pdf", width=3.3, height=2.7)
DimPlot(OL, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OL_umap_Condition_res0.3.pdf", width=10, height=6)
DimPlot(OL, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_OL_umap_Sample_res0.3.pdf", width=18, height=12)
DimPlot(OL, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OL) <- 'RNA'
LG93E4_OL_markers <- FindAllMarkers(OL, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_OL_markers, "LG93E4_OL_markers_res0.3.csv")
...
saveRDS(OPC, file = 'LG93E4_OPC_reclusted_res0.15.rds')
pdf("LG93E4_OPC_umap.pdf", width=3.3, height=2.7)
DimPlot(OPC, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OPC_umap_Condition.pdf", width=10, height=6)
DimPlot(OPC, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_OPC_umap_Sample.pdf", width=18, height=12)
DimPlot(OPC, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OPC) <- 'RNA'
LG93E4_OPC_markers <- FindAllMarkers(OPC, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_OPC_markers, "LG93E4_OPC_markers.csv")
...
OPC@active.ident <- plyr::mapvalues(x = OPC@active.ident, from = current.cluster.ids, to = new.cluster.ids)
OPC@active.ident <- factor(OPC@active.ident, levels=1:n)
saveRDS(OPC, file = 'LG93E4_OPC_reclusted_res0.2.rds')
pdf("LG93E4_OPC_umap_res0.2.pdf", width=3.3, height=2.7)
DimPlot(OPC, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OPC_umap_Condition_res0.2.pdf", width=10, height=6)
DimPlot(OPC, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_OPC_umap_Sample_res0.2.pdf", width=18, height=12)
DimPlot(OPC, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OPC) <- 'RNA'
LG93E4_OPC_markers <- FindAllMarkers(OPC, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_OPC_markers, "LG93E4_OPC_markers_res0.2.csv")
...
OPC@active.ident <- plyr::mapvalues(x = OPC@active.ident, from = current.cluster.ids, to = new.cluster.ids)
OPC@active.ident <- factor(OPC@active.ident, levels=1:n)
saveRDS(OPC, file = 'LG93E4_OPC_reclusted_res0.3.rds')
pdf("LG93E4_OPC_umap_res0.3.pdf", width=3.3, height=2.7)
DimPlot(OPC, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OPC_umap_Condition_res0.3.pdf", width=10, height=6)
DimPlot(OPC, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_OPC_umap_Sample_res0.3.pdf", width=18, height=12)
DimPlot(OPC, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OPC) <- 'RNA'
LG93E4_OPC_markers <- FindAllMarkers(OPC, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_OPC_markers, "LG93E4_OPC_markers_res0.3.csv")
...
saveRDS(IN, file = 'LG93E4_IN_reclusted_res0.1.rds')
pdf("LG93E4_IN_umap_res0.3.pdf", width=3.3, height=2.7)
DimPlot(IN, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_IN_umap_Condition_res0.3.pdf", width=10, height=6)
DimPlot(IN, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_IN_umap_Sample_res0.3.pdf", width=18, height=12)
DimPlot(IN, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(IN) <- 'RNA'
LG93E4_IN_markers <- FindAllMarkers(IN, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_IN_markers, "LG93E4_IN_markers_res0.3.csv")
...
saveRDS(EN, file = 'LG93E4_EN_reclusted_res0.1.rds')
pdf("LG93E4_EN_umap_res0.3.pdf", width=3.3, height=2.7)
DimPlot(EN, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_EN_umap_Condition_res0.1.pdf", width=10, height=6)
DimPlot(EN, reduction = "umap", split.by = "Condition", label = T, ncol = 4)
dev.off()
pdf("LG93E4_EN_umap_Sample_res0.1.pdf", width=18, height=12)
DimPlot(EN, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(EN) <- 'RNA'
LG93E4_EN_markers <- FindAllMarkers(EN, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_EN_markers, "LG93E4_EN_markers_res0.1.csv")
...
setwd("/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier/DEGs")
#LG93E4 vs Ctrl
...
#######################################################################
setwd("/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier/subclustering_XXO_P301S")
MG <- XXO_P301S_MG
DefaultAssay(MG) <- 'integrated'
MG <- ScaleData(MG, verbose = FALSE)
MG <- RunPCA(MG, features = VariableFeatures(object = MG), verbose = FALSE)
...
DimPlot(MG, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_MG_umap_Condition_res0.15.pdf", width=5.5, height=2.7)
DimPlot(MG, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_MG_umap_Sample_res0.15.pdf", width=11, height=2)
DimPlot(MG, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(MG) <- 'RNA'
LG93E4_MG_markers <- FindAllMarkers(MG, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(MG, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_MG_umap_Condition_res0.2.pdf", width=5.5, height=2.7)
DimPlot(MG, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_MG_umap_Sample_res0.2.pdf", width=11, height=2)
DimPlot(MG, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(MG) <- 'RNA'
LG93E4_MG_markers <- FindAllMarkers(MG, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(MG, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_MG_umap_Condition_res0.3.pdf", width=5.5, height=2.7)
DimPlot(MG, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_MG_umap_Sample_res0.3.pdf", width=11, height=2)
DimPlot(MG, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(MG) <- 'RNA'
LG93E4_MG_markers <- FindAllMarkers(MG, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(AST, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_AST_umap_Condition.pdf", width=5.5, height=2.7)
DimPlot(AST, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_AST_umap_Sample.pdf", width=11, height=2)
DimPlot(AST, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(AST) <- 'RNA'
LG93E4_AST_markers <- FindAllMarkers(AST, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(AST, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_AST_umap_Condition_res0.2.pdf", width=5.5, height=2.7)
DimPlot(AST, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_AST_umap_Sample_res0.2.pdf", width=11, height=2)
DimPlot(AST, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(AST) <- 'RNA'
LG93E4_AST_markers <- FindAllMarkers(AST, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(AST, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_AST_umap_Condition_res0.3.pdf", width=5.5, height=2.7)
DimPlot(AST, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_AST_umap_Sample_res0.3.pdf", width=11, height=2)
DimPlot(AST, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(AST) <- 'RNA'
LG93E4_AST_markers <- FindAllMarkers(AST, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(OL, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OL_umap_Condition.pdf", width=5.5, height=2.7)
DimPlot(OL, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_OL_umap_Sample.pdf", width=11, height=2)
DimPlot(OL, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OL) <- 'RNA'
LG93E4_OL_markers <- FindAllMarkers(OL, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(OL, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OL_umap_Condition_res0.2.pdf", width=5.5, height=2.7)
DimPlot(OL, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_OL_umap_Sample_res0.2.pdf", width=11, height=2)
DimPlot(OL, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OL) <- 'RNA'
LG93E4_OL_markers <- FindAllMarkers(OL, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(OL, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OL_umap_Condition_res0.3.pdf", width=5.5, height=2.7)
DimPlot(OL, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_OL_umap_Sample_res0.3.pdf", width=11, height=2)
DimPlot(OL, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OL) <- 'RNA'
LG93E4_OL_markers <- FindAllMarkers(OL, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(OPC, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OPC_umap_Condition.pdf", width=5.5, height=2.7)
DimPlot(OPC, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_OPC_umap_Sample.pdf", width=11, height=2)
DimPlot(OPC, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OPC) <- 'RNA'
LG93E4_OPC_markers <- FindAllMarkers(OPC, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(OPC, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OPC_umap_Condition_res0.2.pdf", width=5.5, height=2.7)
DimPlot(OPC, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_OPC_umap_Sample_res0.2.pdf", width=11, height=2)
DimPlot(OPC, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OPC) <- 'RNA'
LG93E4_OPC_markers <- FindAllMarkers(OPC, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(OPC, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_OPC_umap_Condition_res0.3.pdf", width=5.5, height=2.7)
DimPlot(OPC, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_OPC_umap_Sample_res0.3.pdf", width=11, height=2)
DimPlot(OPC, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(OPC) <- 'RNA'
LG93E4_OPC_markers <- FindAllMarkers(OPC, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(IN, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_IN_umap_Condition_res0.3.pdf", width=5.5, height=2.7)
DimPlot(IN, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_IN_umap_Sample_res0.3.pdf", width=11, height=2)
DimPlot(IN, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(IN) <- 'RNA'
LG93E4_IN_markers <- FindAllMarkers(IN, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
...
DimPlot(EN, reduction = 'umap', label = T)
dev.off()
pdf("LG93E4_EN_umap_Condition_res0.3.pdf", width=5.5, height=2.7)
DimPlot(EN, reduction = "umap", split.by = "Condition", label = T, ncol = 2)
dev.off()
pdf("LG93E4_EN_umap_Sample_res0.3.pdf", width=11, height=2)
DimPlot(EN, reduction = "umap", split.by = "Sample_Name", label = T, ncol = 6)
dev.off()
DefaultAssay(EN) <- 'RNA'
LG93E4_EN_markers <- FindAllMarkers(EN, logfc.threshold = 0.1, test.use = "MAST",min.pct = 0.25, only.pos = T)
write.csv(LG93E4_EN_markers, "LG93E4_EN_markers_res0.3.csv")
...
#######################################################################
setwd("/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier/subclustering_XYO_P301S")
MG <- XYO_P301S_MG
DefaultAssay(MG) <- 'integrated'
MG <- ScaleData(MG, verbose = FALSE)
MG <- RunPCA(MG, features = VariableFeatures(object = MG), verbose = FALSE)
...
#######################################################################
setwd("/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier/subclustering_XXT_P301S")
MG <- XXT_P301S_MG
DefaultAssay(MG) <- 'integrated'
MG <- ScaleData(MG, verbose = FALSE)
MG <- RunPCA(MG, features = VariableFeatures(object = MG), verbose = FALSE)
...
#######################################################################
setwd("/athena/ganlab/scratch/lif4001/LG93E4/integration_without_outlier/subclustering_XYT_P301S")
MG <- XYT_P301S_MG
DefaultAssay(MG) <- 'integrated'
MG <- ScaleData(MG, verbose = FALSE)
MG <- RunPCA(MG, features = VariableFeatures(object = MG), verbose = FALSE)
